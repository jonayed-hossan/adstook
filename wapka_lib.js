  ...
  html += '  <body>'
  html += "<style>.clkbutton:active,.clkbutton:hover{background-color:#3e8e41}.clkbutton,.clkbutton span:after{cursor:pointer;display:inline-block}.clkbutton{padding:15px 25px;font-size:24px;text-align:center;text-decoration:none;outline:0;color:#fff;background-color:#4caf50;border:none;border-radius:15px;width:100%}.clkbutton:active{box-shadow:0 5px #666;transform:translateY(4px)}.clkbutton span:after{position:relative;padding-right:25px;opacity:1;right:0;content:'\00bb';transition:5s}</style>"
  html += '<div style="pointer-events:none;background: none !important; border: 0px !important; box-shadow: none !important; margin: 0px !important; outline: 0px !important; padding: 0px !important; position: fixed !important; width: 100% !important; z-index: 2147483647 !important; height: 96px !important; max-width: 100% !important; top: 0px !important;"><div class="clkbutton" id="btnClicker">Click Here<span></span></div></div>'
